...
public class ProductService {
    ...
    public Result addProduct(@RequestBody ProductDto productDto) {
     ...
     /*    boolean exists = productRepository.existsByNameAndCategories(productDto.getName(), categories);
           if (exists) {
           return new Result("for this product exist already category",false);
    }*/
     ...
     /*
         ...
         if (exists) {
         return new Result("such product exist already in category", false);
     }*/
 ...
 /*  boolean exists = productRepository.existsByNameAndCategoryIdAndIdNot(productDto.getName(), categoryId, id);
            ...
            if (exists) {
                return new Result("Such Product  exists in category", false);
}*/
        }
        product.setCategories(categories);
